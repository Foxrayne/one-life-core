...
Existing client-side patches: MainScreenStatePatch, UIWorldMapPatch, LuaEventManagerPatch, TISLogoStatePatch, PacketReceivedPatch, ChatManagerPatch, LuaExposerDumpPatch, LuaManagerPatch, DebugLogPatch, ThreadPatch, AdvancedAnimatorMissingFolderPatch.
